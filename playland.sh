...
CREATE TABLE items (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, uname VARCHAR2(20) NOT NULL, email VARCHAR2(20) NOT NULL, phone VARCHAR2(20) NOT NULL, s3rawurl VARCHAR2(255) NOT NULL, s3finishedurl VARCHAR2(255) NOT NULL, jpgfilename VARCHAR2(255) NOT NULL, status TINYINT(3)CHECK(state IN(0,1,2)), date DATETIME DEFAULT CURRENT_TIMESTAMP);
